...
// node_modules/element-plus/es/el-select/index.js
...
var useSelect = (props, states, ctx) => {
  ...
  watch(() => props.modelValue, (val, oldVal) => {
    ...
    if (!(0, import_isEqual.default)(val, oldVal)) {
  ...
  const debouncedOnInputChange = (0, import_debounce.default)(() => {
    onInputChange();
  }, debounce.value);
  const debouncedQueryChange = (0, import_debounce.default)((e) => {
    handleQueryChange(e.target.value);
  }, debounce.value);
  const emitChange = (val) => {
    if (!(0, import_isEqual.default)(props.modelValue, val)) {
...
var _hoisted_1 = { class: "select-trigger" };
var _hoisted_2 = { key: 0 };
var _hoisted_3 = { class: "el-select__tags-text" };
var _hoisted_4 = { style: { "height": "100%", "display": "flex", "justify-content": "center", "align-items": "center" } };
var _hoisted_5 = {
  key: 1,
...
var _Select = script$2;
var el_select_default = _Select;

export {
  script,
  el_select_default
};
//# sourceMappingURL=chunk-QQGBYNZS.js.map
