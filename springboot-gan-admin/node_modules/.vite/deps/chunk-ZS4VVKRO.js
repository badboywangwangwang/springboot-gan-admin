...
// node_modules/element-plus/es/el-loading/index.js
...
var addStyle = (options, parent, instance) => __async(void 0, null, function* () {
  const maskStyle = {};
  if (options.fullscreen) {
    instance.originalPosition.value = getStyle(document.body, "position");
    instance.originalOverflow.value = getStyle(document.body, "overflow");
    maskStyle.zIndex = String(popup_manager_default.nextZIndex());
...
var el_loading_default = index;

export {
  el_loading_default
};
//# sourceMappingURL=chunk-ZS4VVKRO.js.map
