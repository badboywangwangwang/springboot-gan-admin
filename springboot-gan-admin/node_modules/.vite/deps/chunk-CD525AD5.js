...
// node_modules/element-plus/es/el-popover/index.js
...
function usePopover(props, ctx) {
  const zIndex = ref(popup_manager_default.nextZIndex());
  ...
  watch(popperProps.visibility, (val) => {
    if (val) {
      zIndex.value = popup_manager_default.nextZIndex();
    }
...
var _Popover = script;
var el_popover_default = _Popover;

export {
  el_popover_default
};
//# sourceMappingURL=chunk-CD525AD5.js.map
