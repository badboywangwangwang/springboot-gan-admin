...
// node_modules/element-plus/es/el-collapse-transition/index.js
...
var _CollapseTransition = script;
var el_collapse_transition_default = _CollapseTransition;

// node_modules/element-plus/es/el-submenu/index.js
...
var script2 = defineComponent({
  ...
  render() {
    ...
    const child = this.isMenuPopup ? h(el_popper_default, {
      ref: "popperVNode",
      manualMode: true,
      visible: this.opened,
      ...
      h(el_collapse_transition_default, {}, {
        default: () => {
          var _a2, _b2;
...
script2.__file = "packages/menu/src/submenu.vue";
script2.install = (app) => {
  app.component(script2.name, script2);
};
var _Submenu = script2;
var el_submenu_default = _Submenu;

export {
  el_collapse_transition_default,
  el_submenu_default
};
//# sourceMappingURL=chunk-QN4L3E5D.js.map
